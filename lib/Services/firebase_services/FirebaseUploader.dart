...
class FirebaseUploader {
  ...
  Future<String?> uploadFile(
      ...
      String? collection,
      String? folder}) async {
    // final timep=Provider.of<CurrentTime>(this.context,listen: false);
          ...
          return WillPopScope(
              ...
              child: AlertDialog(
                ...
                content: new SingleChildScrollView(
                  child: Text(error.toString().contains('not authorized')
                      ? "Kindly the Set the FIREBASE STORAGE > Security Rules"
                      : error.toString()),
                ),
                actions: <Widget>[
                  ElevatedButton(
