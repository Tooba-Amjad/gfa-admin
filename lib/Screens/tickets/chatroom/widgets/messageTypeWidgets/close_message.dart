...
Widget getTicketClosedMessage({required BuildContext context, required TicketMessage mssg, required String customerUID, required bool cuurentUserCanSeeAgentNamePhoto}) {
      ...
      Chip(
        ...
        label: MtCustomfontBoldSemi(
          text: mssg.tktMssgSENDBY == customerUID
              ? " ${getTranslatedForCurrentUser(context, 'xxxxisclosedbyxxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxcustomerxx')}')} "
              : " ${getTranslatedForCurrentUser(context, 'xxxxisclosedbyxxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxadminxx')}')} ",
