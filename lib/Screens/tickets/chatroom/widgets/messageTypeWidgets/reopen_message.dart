      ...
      Chip(
        ...
        label: MtCustomfontBoldSemi(
          text: mssg.tktMssgSENDBY == customerUID
              ...
              : " ${getTranslatedForCurrentUser(context, 'xxrequestedxx').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxagentxx')}')} ",
          color: Colors.white,
          fontsize: 13,
        ),
      ),
