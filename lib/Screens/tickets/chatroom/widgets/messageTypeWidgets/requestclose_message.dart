      ...
      Chip(
        ...
        label: MtCustomfontBoldSemi(
          text: mssg.tktMssgSENDBY == customerUID
              ? " ${getTranslatedForCurrentUser(context, 'xxxreopenedbyxxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxcustomerxx')}')} "
              : " ${getTranslatedForCurrentUser(context, 'xxxreopenedbyxxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxagentxx')}')} ",
          color: Colors.white,
          fontsize: 13,
        ),
      ),
