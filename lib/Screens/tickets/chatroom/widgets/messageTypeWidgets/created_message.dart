      ...
      Chip(
        ...
        label: MtCustomfontBoldSemi(
          text: mssg.tktMssgSENDBY == customerUID
              ? " ${getTranslatedForCurrentUser(context, 'xxcreatedbyxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxcustomerxx')}')} "
              : " ${getTranslatedForCurrentUser(context, 'xxcreatedbyxx').replaceAll('(####)', '${getTranslatedForCurrentUser(context, 'xxtktsxx')}').replaceAll('(###)', '${getTranslatedForCurrentUser(context, 'xxagentxx')}')} ",
