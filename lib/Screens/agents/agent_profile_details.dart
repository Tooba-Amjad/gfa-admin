            ...
            AppConstants.isdemomode == true
                ...
                : () async {
                    ...
                    await colRef.doc(userid).update({
                      ...
                      await FirebaseFirestore.instance.collection(DbPaths.collectionagents).get().then((value) {
                        tapproved = value.docs.where((element) => element[Dbkeys.accountstatus] == Dbkeys.sTATUSallowed).length;
                        tblocked = value.docs.where((element) => element[Dbkeys.accountstatus] == Dbkeys.sTATUSblocked).length;
                        tpending = value.docs.where((element) => element[Dbkeys.accountstatus] == Dbkeys.sTATUSpending).length;
                      }).then((value) async {
                                ...
                                onSuccessFn: () async {
                                  await firestore.updateparticulardocinProvider(
                                      ...
                                      onfetchDone: (userDoc) async {
                                        ...
                                        await ShowLoading().close(context: this.context, key: _keyLoader);
                                        _controller.clear();
                      ...
                      ShowSnackbar().open(
                          ...
                          label: observer.isshowerrorlog == false
                              ...
                              : getTranslatedForCurrentUser(this.context, 'xxxfailedntryagainxxx') + error.toString());
                    });
                  });
  }
