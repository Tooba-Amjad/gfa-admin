...
import 'package:thinkcreative_technologies/Screens/agents/create_agent.dart';
...
class _AllAgentsState extends State<AllAgents> {
  ...
  confirmchangeswitch(
    ...
    final firestore =
        Provider.of<FirestoreDataProviderAGENTS>(this.context, listen: false);
                          ...
                          await FirebaseApi.runTransactionRecordActivity(
                            ...
                            plainDesc: accountSTATUS == Dbkeys.sTATUSallowed
                                ...
                                : accountSTATUS == Dbkeys.sTATUSpending
                                    ...
                                    : accountSTATUS == Dbkeys.sTATUSblocked
                                        ? '$fullname (${getTranslatedForCurrentUser(this.context, 'xxagentxx')}) ${getTranslatedForCurrentUser(this.context, 'xxxaccountxx')} ${getTranslatedForCurrentUser(this.context, 'xxxapprovedxxx')}. ${getTranslatedForCurrentUser(this.context, 'xxxbyxxx')} ${widget.currentuserid}  '
          ...
          return Container(
            ...
            child: Column(children: [
              ...
              MtCustomfontBold(
                ...
                fontsize: 18,
                text:
                    '${getTranslatedForCurrentUser(this.context, 'xxxsearchxxx')} ${getTranslatedForCurrentUser(this.context, 'xxagentxx')}',
              ),
              SizedBox(
                height: 35,
              ),
  ...
  sort(BuildContext context, String sortby) {
    ...
    setState(() {});
    firestore.reset();
    firestore.fetchNextData(Dbkeys.dataTypeAGENTS, query, true);
  }
      ...
      child: Utils.getNTPWrappedWidget(Consumer<Observer>(
          builder: (context, observer, _child) => Consumer<CommonSession>(
                builder: (context, session, _child) =>
                    Consumer<FirestoreDataProviderAGENTS>(
                  builder: (context, firestoreDataProvider, _) => MyScaffold(
                      ...
                      actions: [
                        IconButton(
                          ...
                          onPressed: () {
                            pageNavigator(this.context, CreateAgent());
                          },
                        ),
                        IconButton(
                          icon: Icon(
                      ...
                      body: InfiniteCOLLECTIONListViewWidgetAdmin(
                        firestoreDataProviderAGENTS: firestoreDataProvider,
                        datatype: Dbkeys.dataTypeAGENTS,
                        refdata: query,
                        list: Column(
                          children: [
                            isready == false
                            ...
                            ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int i) {
                                  AgentModel agent = AgentModel.fromJson(
                                      firestoreDataProvider.recievedDocs[i]);
