...
class CameraImageGalleryPicker extends StatefulWidget {
  ...
  final bool? isPickFromgalleryShow;
  final bool? isPickFromCameraShow;

  const CameraImageGalleryPicker(
      {Key? key,
      required this.onTakeFile,
      this.isPickFromCameraShow,
      this.isPickFromgalleryShow})
      : super(key: key);
  @override
        ...
        child: Scaffold(
          ...
          body: Stack(
            ...
            children: [
              Align(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: MediaQuery.of(this.context).padding.top + 30),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      //       : null,
                      // ),
                      widget.isPickFromgalleryShow == null ||
                              widget.isPickFromgalleryShow == true
                          ? IconButton(
                              onPressed: () async {
                                // Navigator.of(this.context).pop();
                                File? selectedMedia =
                                    await pickSingleImage(this.context)
                                        .catchError((err) {
                                  Utils.toast(
                                ...
                                if (selectedMedia == null) {
                                  ...
                                  if (fileExtension == ".png" ||
                                    ...
                                    File file = await File(fileExtension ==
                                                ".png"
              ...
              Platform.isIOS
                  ? Positioned(
                      top: MediaQuery.of(this.context).padding.top - 10,
                      right: 12,
                      child: Align(
                          alignment: Alignment.topCenter,
                          child: IconButton(
                  ...
                  : SizedBox()
              // Positioned(
              //   top: MediaQuery.of(this.context).padding.top + 30 + 10,
              //   child: Align(
              //     alignment: Alignment.topCenter,
              //     child:
              //   ),
