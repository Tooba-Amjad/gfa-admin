                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                          onPressed: () async {
                            File? selectedMedia = await pickMultiMedia(
                                    this.context,
                                    type: widget.isShowImage == true &&
                                            widget.isShowVideo == true
                                        ? RequestType.common
                                        : widget.isShowImage == false
                                            ? RequestType.video
                                            : RequestType.image)
                                .catchError((err) {
                              Utils.toast("Invalid FIle");
                              return null;
                            });
