...
import 'package:thinkcreative_technologies/Widgets/placeholder_generate.dart';
...
class InputGroup3small extends StatefulWidget {
  final Color? boxbcgcolor;
  final Color? boxbordercolor;
  final double? boxborderwidth;
  final double? boxcornerradius;
  ...
  final String val2;
  final String val3;
  final String? val1String;
  final String? val2String;
  final String? val3String;
  final String? subtitle;
  final String? selectedvalue;
  final Function(String? val)? onChanged;
  ...
  @override
  _InputGroup3smallState createState() => _InputGroup3smallState();
}

class _InputGroup3smallState extends State<InputGroup3small> {
  // String myvalue;
  @override
  void initState() {
    super.initState();
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: MtCustomfontRegular(
                                lineheight: 1.12,
                                fontsize: 12,
                                text: widget.val1String ?? widget.val1,
                              ),
                            )
                          ])),
                  myverticaldivider(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: MtCustomfontRegular(
                                lineheight: 1.12,
                                fontsize: 12,
                                text: widget.val2String ?? widget.val2,
                              ),
                            )
                          ])),
                  myverticaldivider(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: MtCustomfontRegular(
                                lineheight: 1.12,
                                fontsize: 12,
                                text: widget.val3String ?? widget.val3,
                              ),
                            )
                          ])),
                ],
...
class InputGroup4Large extends StatefulWidget {
  final Color? boxbcgcolor;
  final Color? boxbordercolor;
  final double? boxborderwidth;
  final double? boxcornerradius;
  ...
  @override
  _InputGroup4LargeState createState() => _InputGroup4LargeState();
}

class _InputGroup4LargeState extends State<InputGroup4Large> {
  // String myvalue;
  @override
  void initState() {
    super.initState();
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: MtCustomfontRegular(
                                    lineheight: 1.12,
                                    fontsize: 12,
                                    text: widget.val4String ?? widget.val4,
                                  ),
                                )
                              ])),
                    ],
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: widget.boxheight ?? widget.boxwidth! * 0.52,
                width: widget.boxwidth ?? w,
                decoration: BoxDecoration(
                    color: widget.boxbcgcolor ?? Colors.white,
                    border: Border.all(
                        ...
                        PinchZoom(
                          child: CachedNetworkImage(
                            ...
                            imageUrl: widget.photourl ??
                                PlaceholderGenerate()
                                    .make(widget.placeholder ?? '900x465'),
