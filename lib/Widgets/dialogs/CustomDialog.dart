...
class ShowCustomAlertDialog {
  open({
    ...
    showDialog(
        ...
        builder: (context) {
          return Builder(
              builder: (BuildContext popable) => Dialog(
  ...
  open(
    ...
    showGeneralDialog(
        ...
        transitionBuilder: (context, a1, a2, child) {
          return Builder(
              builder: (BuildContext popable) => ScaleTransition(
                  ...
                  child: AlertDialog(
                    ...
                    title: MtCustomfontBold(
                      text: title ??
                          getTranslatedForCurrentUser(popable, 'xxgobackxx'),
                      fontsize: 17,
            ...
            builder: (BuildContext popable) => ScaleTransition(
                ...
                child: AlertDialog(
                  ...
                  content: isshowform == false
                      ...
                      : Container(
                          height: MediaQuery.of(popable).size.height / 2.7,
                          child: Column(
                            children: [
                              Text(subtitle ??
