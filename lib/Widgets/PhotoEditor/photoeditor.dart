...
import 'package:thinkcreative_technologies/Widgets/PhotoEditor/widgets/image_picker/_image_picker_io.dart';
...
class _PhotoEditorState extends State<PhotoEditor> {
  ...
  List<AspectRatioItem> _aspectRatios(BuildContext context) {
    return <AspectRatioItem>[
      AspectRatioItem(
          text: getTranslatedForCurrentUser(context, 'xxcustomxx'),
          value: CropAspectRatios.custom),
      AspectRatioItem(
          text: getTranslatedForCurrentUser(context, 'xxoriginalxx'),
  ...
  void initState() {
    ...
    _aspectRatio = _aspectRatios(context).first;
            ...
            child: ListView(
              ...
              children: [
                FlatButtonWithIcon(
                  ...
                  label: Text(
                    getTranslatedForCurrentUser(context, 'xxcropxx'),
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: _aspectRatios(context).length,
                                ),
                              ),
                            ],
                          );
                ...
                FlatButtonWithIcon(
                  ...
                  label: Text(
                    getTranslatedForCurrentUser(context, 'xxflipxx'),
                    style: TextStyle(fontSize: 10.0, color: bottomIconColor),
                  ),
                ...
                FlatButtonWithIcon(
                  ...
                  label: Text(
                    getTranslatedForCurrentUser(context, 'xxrotateleftxx'),
                    style: TextStyle(
                      fontSize: 8.0,
                      color: bottomIconColor,
                    ),
                ...
                FlatButtonWithIcon(
                  ...
                  label: Text(
                    getTranslatedForCurrentUser(context, 'xxrotaterightxx'),
                    style: TextStyle(
                      fontSize: 8.0,
                      color: bottomIconColor,
                    ),
                ...
                FlatButtonWithIcon(
                  ...
                  label: PopupMenuButton<EditorCropLayerPainter>(
                    ...
                    child: Text(
                      getTranslatedForCurrentUser(context, 'xxpainterxx'),
                      style: TextStyle(
                        fontSize: 8.0,
                        color: bottomIconColor,
                      ),
                      ...
                      if (_cropLayerPainter != value) {
                        setState(() {
                          if (value is CircleEditorCropLayerPainter) {
                            _aspectRatio = _aspectRatios(context)[2];
                          }
                ...
                FlatButtonWithIcon(
                  ...
                  label: Text(
                    getTranslatedForCurrentUser(context, 'xxresetxx'),
                    style: TextStyle(
                      fontSize: 10.0,
                      color: bottomIconColor,
                    ),
  ...
  Future<void> _getImage() async {
    _memoryImage = await pickImage(this.context);
