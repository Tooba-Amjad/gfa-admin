...
import 'package:thinkcreative_technologies/widgets/VideoEditor/export_service.dart';
...
class _VideoEditorState extends State<VideoEditor> {
  ...
  void _exportCover({required Function(File file) onGenCover}) async {
    ...
    if (execute == null) {
      Utils.toast("Error on cover exportation initialization.");
      return;
    }

    await ExportService.runFFmpegCommand(
      execute,
      onError: (e, s) => Utils.toast("Error on cover exportation :("),
      onCompleted: (cover) {
        if (!mounted) return;
  ...
  void _exportVideo() async {
    ...
    await ExportService.runFFmpegCommand(
      ...
      onProgress: (stats) {
        _exportingProgress.value = config.getFFmpegProgress(stats.hashCode);
      },
      onError: (e, s) {
        Utils.toast("Failed to export");
      },
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                              ...
                                              children: [
                                                ...
                                                if (Optionalconstants
                                                        .isShowTextLabelsInPhotoVideoEditorPage ==
                                                    true)
                                                  Text(
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            Row(children: [
              ...
              buildSplashTap(
                  getTranslatedForCurrentUser(context, 'xxnoxx').toUpperCase(),
                  null,
              ...
              Expanded(
                child: SplashTap(
                  ...
                  child: Center(
                    child: Text(
                      getTranslatedForCurrentUser(context, 'xxokxx')
                          .toUpperCase(),
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.white),
                    ),
